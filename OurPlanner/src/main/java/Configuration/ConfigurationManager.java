...
public class ConfigurationManager {
	...
	private OurPlannerConfiguration currentConfiguration = new OurPlannerConfiguration();

	private ConfigurationManager(){
		
		currentConfiguration = new OurPlannerConfiguration();
	...
	public OurPlannerConfiguration getCurrentConfiguration() {
	...
	public boolean loadConfiguration(String configurationFilePath) {
		...
		try {
			...
			if(confFile.isFile()) {
				currentConfiguration =  mapper.readValue(confFile, OurPlannerConfiguration.class);
				return true;
			}
				...
				currentConfiguration =  mapper.readValue(configDir[0], OurPlannerConfiguration.class);
