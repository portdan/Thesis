...
import cz.agents.dimaptools.search.ParentState;
...
public class GlobalLocalDistributedBestFirstSearch implements SearchInterface {
    ...
    protected double timeLimitMs = Double.MAX_VALUE;
    ...
    public GlobalLocalDistributedBestFirstSearch(DIMAPWorldInterface world,double timeLimitMs) {
