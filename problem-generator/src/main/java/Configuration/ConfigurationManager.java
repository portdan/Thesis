...
public class ConfigurationManager {
	...
	private ProblemGeneratorConfiguration currentConfiguration = new ProblemGeneratorConfiguration();
	...
	public ProblemGeneratorConfiguration getCurrentConfiguration() {
	...
	public boolean loadConfiguration(String configurationFilePath) {
		...
		try {
			...
			if(confFile.isFile()) {
				currentConfiguration =  mapper.readValue(confFile, ProblemGeneratorConfiguration.class);
				return true;
			}
				...
				currentConfiguration =  mapper.readValue(configDir[0], ProblemGeneratorConfiguration.class);
