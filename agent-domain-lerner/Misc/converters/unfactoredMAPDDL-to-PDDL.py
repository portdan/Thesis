...
class PlanningProblem(object):
  def __init__(self, domainfile, problemfile, agent, type):
    self.domain = '' #String
...
def main():
    ...
    pp = PlanningProblem(args.folder + "/" + args.domain + ".pddl", args.folder + "/" + args.problem + ".pddl", args.agent , args.type)
    ...
    pp.write_pddl_domain(args.output + "/" + args.domain + ".pddl")
    pp.write_pddl_problem(args.output + "/" + args.problem + ".pddl")
    pp.write_addl(args.output + "/" + args.problem + ".addl")
    
    pp.write_agent_list(args.output + "/" + args.problem + ".agents")
...
def parse_args():
    ...
    argparser.add_argument(
        "agent", help="agent to keep name", type=str)
    argparser.add_argument(
        "type", help="agent to keep type", type=str)
    argparser.add_argument(
